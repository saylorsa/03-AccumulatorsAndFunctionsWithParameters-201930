...
def two_circles():
    ...
    circle1=rg.Circle(rg.Point(50,50),12)
    circle1.fill_color='orange'
    circle1.attach_to(window)
    circle2=rg.Circle(rg.Point(200,100),20)
...
def lines():
    ...
    window=rg.RoseWindow()
    line1=rg.Line(rg.Point(70,4),rg.Point(100,130))
    line2=rg.Line(rg.Point(150,170),rg.Point(200,40))
    line2.thickness=5
    line1.attach_to(window)
    line2.attach_to(window)
    pint=line2.get_midpoint()
    print(pint)
    print(pint.x)
    print(pint.y)
    window.render()
